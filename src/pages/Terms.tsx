...
const Terms = () => {
  return (
    <Layout>
      <SEOHead
        title="Termos de Uso | ICS Serviços Especializados"
        description="Termos de uso do site da ICS Serviços Especializados. Condições de acesso e utilização do site."
      />
