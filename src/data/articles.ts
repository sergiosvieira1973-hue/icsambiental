...
export const articles: Article[] = [
  {
    ...
    date: '2025-01-15',
    readingTime: '6 min',
    author: 'Equipe ICS Ambiental',
    seoTitle: 'Licenciamento ambiental: como evitar retrabalho | ICS Ambiental',
  ...
  },
  {
    ...
    content: [
      ...
      'A ICS Ambiental ajuda seus clientes a implantar rotinas de controle simples e eficazes, com indicadores sob medida. Fale conosco.',
    ],
    category: 'Resíduos',
    ...
    readingTime: '7 min',
    author: 'Equipe ICS Ambiental',
    seoTitle: 'PGRS na prática: evidências para auditoria | ICS Ambiental',
  ...
  },
  {
    ...
    content: [
      ...
      'A ICS Ambiental oferece o serviço de gestão de condicionantes como parte do acompanhamento pós-licença. Se você tem condicionantes pendentes ou quer evitar que elas virem um passivo, entre em contato.',
    ],
    category: 'Gestão',
    ...
    readingTime: '5 min',
    author: 'Equipe ICS Ambiental',
    seoTitle: 'Como organizar condicionantes de licença ambiental | ICS Ambiental',
